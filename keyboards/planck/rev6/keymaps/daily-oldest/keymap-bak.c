...
|   Z  |   X  |   C  | A(V) |   B  |      |      |   N  | A(M) |   ,  |   .  |   /  |
|      |      |System|      |S(Esc)|OS_Num| Bsp  |A(Spc)| Tab  |      |      |      |
 */
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, SYSTEM, XXXXXXX, SFTESC, OS_NUM,  KC_BSPC, ARRSPC, KC_ENT, XXXXXXX, XXXXXXX, XXXXXXX
),
...
[_SYMBOL] = LAYOUT_planck_grid(
    XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, KC_GRV,  _______, _______, XXXXXXX, KC_UNDS, KC_AMPR, KC_PIPE, KC_CIRC,
    KC_AT,   KC_DLR,  KC_LPRN, KC_RPRN, KC_EQL,  _______, _______, KC_HASH, KC_EQL,  KC_QUOT, KC_DQUO, KC_GRV,
    KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_EXLM, _______, _______, KC_BSLS, KC_ASTR, KC_MINS, KC_PLUS, KC_TILD,
    _______, _______, _______, _______, KC_EQL,  _______, _______, KC_TAB,  _______, _______, _______, _______
),

/* [_SYMBOL] = LAYOUT_planck_grid( */
/*     KC_DQUO, KC_QUOT, KC_LBRC, KC_RBRC, KC_HASH, _______, _______, XXXXXXX, KC_UNDS, KC_AMPR, KC_PIPE, KC_PERC, */
/*     KC_AT,   KC_DLR,  KC_LPRN, KC_RPRN, KC_GRV,  _______, _______, KC_CIRC, KC_EQL,  KC_ASTR, KC_MINS, KC_EXLM, */
/*     XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, XXXXXXX, _______, _______, XXXXXXX, KC_PLUS, XXXXXXX, KC_TILD, KC_BSLS, */
...
|C(->) | M_L  |M_Down| M_R  |      |      |      | Left | Down |  Up  |Right |C(<-) |
...
[_ARROWS] = LAYOUT_planck_grid(
    KC_PGUP, ALTRGHT, KC_MS_U, XXXXXXX, XXXXXXX, _______, _______, XXXXXXX, KC_WH_D, KC_WH_U, XXXXXXX, KC_ACL2,
    KC_PGDN, KC_MS_L, KC_MS_D, KC_MS_R, XXXXXXX, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_ACL1,
    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______, _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
    _______, _______, _______, KC_BTN2, KC_BTN1, KC_BTN2, _______, _______, _______, _______, _______, _______
),

/* [_ARROWS] = LAYOUT_planck_grid( */
/*     XXXXXXX, ALTRGHT, KC_MS_U, XXXXXXX, XXXXXXX, _______, _______, XXXXXXX, CTLLEFT, KC_ACL1, KC_ACL2, XXXXXXX, */
/*     CTLRGHT, KC_MS_L, KC_MS_D, KC_MS_R, XXXXXXX, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, CTLLEFT, */
/*     XXXXXXX, XXXXXXX, KC_WH_D, KC_WH_U, ALTLEFT, _______, _______, XXXXXXX, KC_PGDN, KC_PGUP, XXXXXXX, XXXXXXX, */
